    ...
    while (steps < 320000) {
      ...
      if (state.wave > activeWave) {
        ...
        activeWaveRecord = {
          ...
          estimatedRisk:Number(waveStartState.encounter?.estimatedRisk) || 0,
          estimatedFatal:Number(waveStartState.encounter?.estimatedFatal) || 0,
          ...
          roleState:waveStartState.encounter?.roleState || "even",
           ...
           rolePower:Number(waveStartState.encounter?.rolePower) || 1,
           combatFit:Number(waveStartState.encounter?.combatFit) || 1,
           loadoutPower:Number(waveStartState.encounter?.loadoutPower) || 1,
